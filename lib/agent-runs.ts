...
export function buildAgentPrompt(ticket: Pick<TicketRow, "id" | "title" | "source_text" | "subtasks" | "agent">, artifactDir: string) {
  ...
  return [
    ...
    "Turn the user's idea into a basic first pass for a website.",
    ...
    "The markdown should explain the concept, the user experience, the implementation approach from Dash, and the setup needed to run the agent flow.",
